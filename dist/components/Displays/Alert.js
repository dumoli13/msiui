...
function Alert({ className, children, color = 'primary', startIcon, onRemove, }) {
    return (_jsxs("div", { className: cx('ring-[1.5px] flex items-start text-14px justify-between w-full p-4 rounded-lg font-medium', {
        ...
        }, className), children: [_jsxs("div", { className: "flex items-start  gap-3 flex-1", children: [_jsx("div", { className: "mt-1", children: startIcon }), _jsx("div", { className: "flex-1 text-justify", children: children })] }), onRemove && (_jsx(Icon, { name: "x-mark", size: 16, strokeWidth: 1.5, onClick: onRemove, className: "cursor-pointer shrink-0 text-neutral-90 mt-1" }))] }));
}
