...
function ErrorFetchingView() {
    return (React.createElement("div", { className: "flex flex-col items-center justify-center gap-6 py-24" },
        ...
        React.createElement("div", { className: "text-center" },
            React.createElement("p", { className: "text-24px text-neutral-100/85 dark:text-neutral-100-dark/85" }, "We couldn't process your request."),
            React.createElement("p", { className: "text-14px text-neutral-100/45 dark:text-neutral-100-dark/45" }, "Cloud server configuration takes 1-3 minutes, please wait."))));
}
