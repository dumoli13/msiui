...
const PDFViewer = ({ open, onClose, url }) => {
    ...
    return createPortal(React.createElement("div", { role: "presentation", id: "modal-container", className: "flex items-center justify-center z-[1300] inset-0 fixed" },
        React.createElement("div", { className: "fixed top-0 left-0 bottom-0 right-0 bg-neutral-100/50 dark:bg-neutral-100-dark/50" }),
        React.createElement("div", { className: "fixed top-0 left-0 w-full h-full" },
            React.createElement("div", { role: "button", "aria-label": "Close", onClick: onClose, className: "absolute top-8 right-8 text-white bg-neutral-100/70 dark:bg-neutral-100-dark/70 hover:bg-opacity-20 z-50 rounded-full cursor-pointer h-[56px] w-[56px] flex justify-center items-center" },
                React.createElement(Icon, { name: "x-mark", size: 16, className: "text-neutral-10 dark:text-neutral-10-dark" })),
            ...
            React.createElement("div", { className: "absolute bottom-8 left-1/2 transform -translate-x-1/2 text-neutral-10 dark:text-neutral-10-dark bg-neutral-100/70 dark:bg-neutral-100-dark/70 p-4 rounded-full flex items-center gap-2 text-lg" },
                ...
                React.createElement("div", { className: "h-6 w-0 border-r border-neutral-10 dark:border-neutral-10-dark" }),
                React.createElement("div", { className: "flex items-center gap-2 px-6" },
                    React.createElement("div", { className: `${scale > 50
                        ...
                        React.createElement(Icon, { name: "minus-circle", size: 24 })),
                    React.createElement("div", { className: "bg-neutral-90 dark:bg-neutral-90-dark rounded-full py-1 px-3" },
                ...
                React.createElement("div", { className: "px-6" },
                    React.createElement("div", { className: "cursor-pointer text-opacity-60 hover:text-opacity-100 rounded-full text-white", onClick: handleShowFullSize, role: "button", "aria-label": "zoom in" }, React.createElement(Icon, { name: showFullSize ? 'minimize2' : 'maximize2', size: 24 })))))), document.body);
};
