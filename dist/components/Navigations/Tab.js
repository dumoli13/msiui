...
const Tab = ({ items, defaultActiveKey, activeKey: propActiveKey, onChange, onTabClick, onTabClose, }) => {
    var _a;
    const [activeKey, setActiveKey] = React.useState(propActiveKey || defaultActiveKey || ((_a = items[0]) === null || _a === void 0 ? void 0 : _a.key));
