 ...
 *
 */
const WarningModal = ({ icon = (_jsx(Icon, { name: "alert-circle", size: 24, strokeWidth: 3, className: "text-warning-main dark:text-warning-main-dark" })), title, content, confirmText = 'Confirm', cancelText = 'Cancel', onConfirm, customAction, }) => {
    ...
    root.render(_jsx(ModalConfirmContainer, { open: true, title: title, icon: icon, onClose: handleClose, onConfirm: () => {
            onConfirm === null || onConfirm === void 0 ? void 0 : onConfirm();
            handleClose();
        }, confirmText: confirmText, cancelText: cancelText, confirmButtonColor: "warning", customAction: customAction, children: content }));
};
