 ...
 */
const Button = ({ children, variant = 'contained', color = 'primary', size = 'default', className, disabled = false, fullWidth = false, loading = false, startIcon, endIcon, onClick, type = 'button', }) => {
    return (React.createElement("button", { disabled: disabled || loading, type: type, onClick: onClick, className: cx('relative rounded-md font-medium h-fit disabled:cursor-not-allowed', {
        ...
        }, className), tabIndex: disabled ? -1 : 0 },
