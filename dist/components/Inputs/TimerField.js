...
const TimerField = (_a) => {
    ...
    const [internalValue, setInternalValue] = React.useState(defaultValue !== undefined ? defaultValue : initialValue);
    ...
    return (_jsxs("div", { className: cx('relative', {
            ...
            'flex items-center gap-4': labelPosition === 'left',
                    ...
                    'py-[9px]': size === 'large',
                            ...
                            'text-18px py-0.5': size === 'large',
                        }), children: _jsx("input", Object.assign({}, props, { tabIndex: !disabled ? 0 : -1, id: inputId, value: displayValue
                                ? `${Math.floor(displayValue / 3600)
                                    ...
                                    .toLocaleString('en-US')
                                    .padStart(2, '0')}`
                                : '', placeholder: focused ? '' : placeholder, onFocus: () => handleFocus('hour'), onChange: () => { }, ref: elementRef, className: "w-full outline-none bg-neutral-10 dark:bg-neutral-10-dark disabled:bg-neutral-20 dark:disabled:bg-neutral-30-dark disabled:cursor-not-allowed", disabled: disabled, autoComplete: "off" })) }), _jsx(InputEndIconWrapper, { loading: loading, error: isError, success: successProp, clearable: clearable && !!focused && !!value, onClear: handleClearValue, endIcon: endIcon, children: (!clearable ||
                            (clearable && !focused) ||
