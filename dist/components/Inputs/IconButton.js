...
const IconButton = React.forwardRef(({ variant = 'contained', color = 'primary', className, disabled = false, loading = false, icon, size = 'default', onClick, title, titleVerticalAlign = 'bottom', titleHorizontalAlign = 'center', ...props }, ref) => {
    return (_jsx(Tooltip, { title: title, verticalAlign: titleVerticalAlign, horizontalAlign: titleHorizontalAlign, disabled: disabled, children: _jsxs("button", { ...props, ref: ref, disabled: disabled || loading, type: "button", onClick: onClick, "aria-label": title, className: cx('relative rounded-md font-medium disabled:cursor-not-allowed shrink-0 leading-none', {
            ...
            // Variants
            {
                ...
                'text-neutral-90 dark:text-neutral-90-dark hover:text-neutral-90 dark:hover:text-neutral-100-dark hover:bg-neutral-30 dark:bg-neutral-30-dark active:text-neutral-100 dark:active:text-neutral-100-dark focus:ring-primary-focus dark:focus:ring-neutral-100-dark': color === 'neutral' && variant === 'text',
                // link
