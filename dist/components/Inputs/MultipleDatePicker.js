...
const MultipleDatePicker = ({ id, name, value: valueProp, defaultValue, initialValue = [], label, labelPosition = 'top', autoHideLabel = false, onChange, className, helperText, placeholder = 'Input date', disabled: disabledProp = false, fullWidth, inputRef, size = 'default', error: errorProp, success: successProp, loading = false, disabledDate = () => false, width, format = 'D/M/YYYY', picker = 'date', required, }) => {
    ...
    return (_jsxs("div", { className: cx('relative text-14px', {
            ...
            'flex items-center gap-4': labelPosition === 'left',
                    ...
                    'py-[3px]': size === 'default',
                    'py-[9px]': size === 'large',
                }), ref: elementRef, style: width ? { width } : undefined, children: [_jsxs("div", { role: "button", tabIndex: !disabled ? 0 : -1, "aria-pressed": "true", className: cx('flex flex-1 gap-x-2 gap-y-1 items-center flex-wrap', {
                            'w-full': fullWidth,
                            ...
                            'cursor-not-allowed': disabled,
                                ...
                                }), children: placeholder }))] }), _jsx(InputEndIconWrapper, { loading: loading, error: isError, success: successProp, clearable: focused && !!value, onClear: handleClearValue, children: (!focused || !value) && (_jsx(Icon, { name: "calendar", strokeWidth: 2, size: 20, onClick: disabled ? undefined : handleDropdown, className: "rounded-full hover:bg-neutral-30 dark:hover:bg-neutral-30-dark text-neutral-70 dark:text-neutral-70-dark transition-color p-0.5" })) })] }), _jsx(InputHelper, { message: helperMessage, error: isError, size: size }), _jsx(InputDropdown, { open: dropdownOpen, elementRef: elementRef, dropdownRef: dropdownRef, maxHeight: 320, children: dropdownContent })] }));
};
