            ...
            'flex items-center gap-4': labelPosition === 'left',
                    ...
                    'ring-3 ring-primary-focus dark:ring-primary-focus-dark !border-primary-main dark:!border-primary-main-dark': focused,
                            ...
                            'cursor-not-allowed': disabled,
                                ...
                                return (_jsx("div", { className: cx('flex items-center', {
                                        'h-[32px]': size === 'default',
                                        'h-[44px]': size === 'large',
                                    }), children: disabled ? (_jsx(Tag, { color: "neutral", children: tagValue })) : (_jsx(Tag, { color: "info", size: size, onRemove: isControlled
                                            ? undefined
