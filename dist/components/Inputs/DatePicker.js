...
const DatePicker = (_a) => {
    var _b, _c, _d;
    var { id, name, value: valueProp, defaultValue, initialValue = null, label, labelPosition = 'top', autoHideLabel = false, onChange, className, helperText, placeholder = 'Input date', disabled: disabledProp = false, fullWidth, inputRef, size = 'default', clearable = false, error: errorProp, success: successProp, loading = false, disabledDate, width, showTime = false, format: formatProps, picker = 'date', required } = _a, props = __rest(_a, ["id", "name", "value", "defaultValue", "initialValue", "label", "labelPosition", "autoHideLabel", "onChange", "className", "helperText", "placeholder", "disabled", "fullWidth", "inputRef", "size", "clearable", "error", "success", "loading", "disabledDate", "width", "showTime", "format", "picker", "required"]);
    ...
    return (_jsxs("div", { className: cx('relative text-14px', {
            ...
            'flex items-center gap-4': labelPosition === 'left',
                    ...
                    'py-[3px]': size === 'default',
                    'py-[9px]': size === 'large',
                }), ref: elementRef, style: width ? { width } : undefined, children: [_jsx("input", Object.assign({}, props, { tabIndex: !disabled ? 0 : -1, id: inputId, value: value ? dayjs(value).format(format) : '', placeholder: focused ? '' : placeholder, className: cx('w-full outline-none bg-neutral-10 dark:bg-neutral-10-dark disabled:bg-neutral-20 dark:disabled:bg-neutral-30-dark text-neutral-90 dark:text-neutral-90-dark disabled:cursor-not-allowed', {
                            'text-14px py-0.5': size === 'default',
                            'text-18px py-0.5': size === 'large',
                        }), disabled: disabled, "aria-label": label, autoComplete: "off", onFocus: handleFocus, onBlur: handleBlur, onClick: handleFocus, onChange: () => { } })), _jsx(InputEndIconWrapper, { loading: loading, error: isError, success: successProp, clearable: clearable && focused && !!value, onClear: handleClearValue, children: (!clearable ||
                            (clearable && !focused) ||
