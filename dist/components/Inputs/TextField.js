    ...
    return (_jsxs("div", { className: cx('relative', {
            ...
            'flex items-center gap-4': labelPosition === 'left',
                    ...
                    'ring-3 ring-primary-focus dark:ring-primary-focus-dark !border-primary-main dark:!border-primary-main-dark': focused,
                        ...
                        }), disabled: disabled, "aria-label": label, ref: elementRef })), _jsx(InputEndIconWrapper, { loading: loading, error: isError, success: successProp, size: size, clearable: clearable && focused && !!value, onClear: handleClearValue, endIcon: endIcon })] }), _jsx(InputHelper, { message: helperMessage, error: isError, size: size })] }));
};
