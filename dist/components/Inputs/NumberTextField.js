...
const NumberTextField = (_a) => {
    ...
    React.useImperativeHandle(inputRef, () => ({
        ...
        reset: () => {
            ...
            setInternalStringValue(initialValue ? initialValue.toString() : '');
        },
        disabled,
    }));
    React.useEffect(() => {
    ...
    const handleChange = (e) => {
        ...
        if (decimalRegex.test(inputValue)) {
            ...
            setInternalStringValue(newValue ? newValue.toString() : '');
            if (!isControlled)
