...
import type { AutoCompleteMultipleProps, AutoCompleteMultipleRef } from './autoCompleteMultiple';
import type { ButtonProps } from './button';
import type { CheckboxProps, CheckboxRef } from './checkbox';
import type { DatePickerProps, DatePickerRef } from './datePicker';
import type { DateRangePickerProps, DateRangePickerRef } from './dateRangePicker';
import type { MultipleDatePickerProps, MultipleDatePickerRef } from './multipleDatePicker';
import type { NumberTextFieldProps, NumberTextfieldRef } from './numberTextField';
...
export type InputPropsRefType = AutoCompleteRef<unknown> | AutoCompleteMultipleRef<unknown> | CheckboxRef | DatePickerRef | DateRangePickerRef | MultipleDatePickerRef | NumberTextfieldRef | PasswordFieldRef | SelectRef<unknown> | SwitchRef | TextAreaRef | TextfieldRef | TimerFieldRef;
...
} & AutoCompleteMultipleProps<unknown>) | ({
    component: 'Checkbox';
} & CheckboxProps) | ({
...
export type FormRule<V = unknown> = BaseRule & {
    [K in keyof AllRuleKeys<V>]: {
        [P in K]: AllRuleKeys<V>[P];
    } & {
