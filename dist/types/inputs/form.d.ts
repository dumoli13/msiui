...
import { AutoCompleteMultipleProps, AutoCompleteMultipleRef } from './autoCompleteMultiple';
...
import { MultipleDatePickerProps, MultipleDatePickerRef } from './multipleDatePicker';
...
export type InputPropsRefType = AutoCompleteRef<any> | AutoCompleteMultipleRef<any> | CheckboxRef | DatePickerRef | DateRangePickerRef | MultipleDatePickerRef | NumberTextfieldRef | PasswordFieldRef | SelectRef<any> | SwitchRef | TextAreaRef | TextfieldRef | TimerFieldRef;
...
export type FormRule = BaseRule & {
    [K in keyof AllRuleKeys]: {
        [P in K]: AllRuleKeys[P];
    } & {
