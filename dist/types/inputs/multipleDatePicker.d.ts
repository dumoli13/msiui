...
export interface MultipleDatePickerProps extends Omit<React.InputHTMLAttributes<HTMLDivElement>, 'value' | 'defaultValue' | 'onChange' | 'size' | 'required' | 'checked' | 'defaultChecked'> {
    value?: MultipleDateValue;
    ...
    placeholder?: string;
    fullWidth?: boolean;
    inputRef?: React.RefObject<MultipleDatePickerRef | null> | React.RefCallback<MultipleDatePickerRef | null>;
    size?: 'default' | 'large';
