...
type UploaderBaseProps = Omit<React.InputHTMLAttributes<HTMLInputElement>, 'onChange' | 'size' | 'required' | 'checked' | 'defaultChecked' | 'placeholder' | 'value' | 'defaultValue' | 'type'> & {
    label?: string;
    labelPosition?: 'top' | 'left';
    autoHideLabel?: boolean;
    helperText?: React.ReactNode;
    fullWidth?: boolean;
    inputRef?: React.RefObject<UploaderRef | null> | React.RefCallback<UploaderRef | null>;
    size?: 'default' | 'large';
    clearable?: boolean;
    accept?: string;
