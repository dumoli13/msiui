export type ModalTransition = 'fade' | 'zoom' | 'grow' | 'slide-up' | 'slide-down' | 'slide-left' | 'slide-right' | 'flip' | 'collapse-top' | 'collapse-bottom' | 'collapse-left' | 'collapse-right';
...
export type ModalAnimation = AnimationWithTransformOrigin | AnimationWithoutTransformOrigin;
