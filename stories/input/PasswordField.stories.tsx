...
const meta: Meta<PasswordFieldProps> = {
  ...
  argTypes: {
    ...
    name: {
      control: 'text',
      description:
        'Name of the PasswordField input, typically used when submitting form data.',
      table: { type: { summary: 'string' } },
    },
    value: {
      control: 'text',
    ...
    initialValue: {
      control: 'text',
      description:
        'Initial internal value for PasswordField when value is not provided.',
      table: {
        type: { summary: 'string' },
      },
    },
    ...
    inputRef: {
      ...
      table: {
        type: {
          summary:
            'React.RefObject<PasswordFieldRef> | React.RefCallback<PasswordFieldRef>',
        },
      },
    },
    size: {
    ...
    type: {
      ...
      description: 'The input type (password or text).',
      table: {
        type: { summary: "'password' | 'text'" },
      },
    },
    required: {
      control: 'boolean',
  ...
  parameters: {
    docs: {
      description: {
        component: `
<h3 style="margin: 0 0 12px; font-size: 18px;">PasswordFieldRef — API Reference</h3>
  ...
  <tbody>
    <tr style="border-bottom:1px solid #f2f2f2;border-left:1px solid #e5e7eb;">
      ...
      <td style="padding:12px;border:none;">
        A reference to the main input element of the PasswordField component.
It will contain an HTMLInputElement after the component is mounted, and can be null before that.
    ...
    <tr style="border-bottom:1px solid #f2f2f2;border-left:1px solid #e5e7eb;">
      ...
      <td style="padding:12px;border:none;">
         The current value of the PasswordField. Can be an empty string if not set.
      </td>
      <td style="padding:12px;border:none;border-right:1px solid #e5e7eb;">
        <span style="background:#f2f4f5;padding:4px 10px;border-radius:6px;font-size:12px;font-family:monospace;border:1px solid #d0d7de;">
          string
    ...
    <tr style="border-bottom:1px solid #f2f2f2;border-left:1px solid #e5e7eb;">
      ...
      <td style="padding:12px;border:none;">
         Focuses the PasswordField input programmatically.
    ...
    <tr style="border-bottom:1px solid #f2f2f2;border-left:1px solid #e5e7eb;">
      ...
      <td style="padding:12px;border:none;">
        Resets the PasswordField value back to the <code>initialValue</code>.
    ...
    <tr>
      ...
      <td style="padding:12px;border:none;">
       Indicates whether the PasswordField input is currently disabled.
...
export const DefaultValue: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'This story demonstrates an uncontrolled PasswordField. To access the input field and its value, use the inputRef.',
      },
      source: {
        code: `
import { useRef } from 'react';
import { PasswordField, PasswordFieldRef } from '@mis-design/react';
...
import { PasswordField } from '@mis-design/react';
...
export const Sizes: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'PasswordField supports two sizes: default and large.',
      },
      source: {
        code: `
import { PasswordField } from '@mis-design/react';
...
const Sizes = () => (
    <div style={{ display: 'flex', gap: 40, flexWrap: 'wrap' }}>
        <PasswordField size="default" label="Size default" placeholder="Input Placeholder..." />
        <PasswordField size="large" label="Size large" placeholder="Input Placeholder..." />
    </div>
);
...
const LabelPosition = () => (
    <div style={{ display: 'flex', gap: 40, flexWrap: 'wrap' }}>
        <PasswordField labelPosition="top" label="Position top" placeholder="Input Placeholder..." helperText="Input helper text" width={500} />
        <PasswordField labelPosition="left" label="Position left" placeholder="Input Placeholder..." helperText="Input helper text" width={500} />
    </div>
);
...
export const SuccessAndError: Story = {
  render: (args) => (
    <div className="flex flex-col gap-10">
      <PasswordField
        {...args}
        label="Neutral PasswordField"
        className="flex-1"
      />
      <PasswordField
        {...args}
        label="Success PasswordField"
        className="flex-1"
        success
      />
      <PasswordField
        {...args}
        label="Error PasswordField"
        className="flex-1"
        error
      />
      <PasswordField
        {...args}
        label="Error PasswordField with message"
        className="flex-1"
  ...
  parameters: {
    docs: {
      description: {
        story:
          'PasswordField can display neutral, success, or error states. Pass a string to `error` to show an error message.',
      },
      source: {
        code: `
import { PasswordField } from '@mis-design/react';
...
const SuccessAndError = () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 40 }}>
        <PasswordField label="Neutral PasswordField" placeholder="Input Placeholder..." helperText="Input helper text" />
        <PasswordField label="Success PasswordField" placeholder="Input Placeholder..." helperText="Input helper text" success />
        <PasswordField label="Error PasswordField" placeholder="Input Placeholder..." helperText="Input helper text" error />
        <PasswordField label="Error PasswordField with message" placeholder="Input Placeholder..." helperText="Input helper text" error="Error with message" />
    </div>
);
...
export const Disabled: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'When `disabled` is true, the PasswordField is not interactive. It can be disabled with or without a pre-filled value.',
      },
      source: {
        code: `
import { PasswordField } from '@mis-design/react';
...
const Disabled = () => (
    <div style={{ display: 'flex', gap: 40, flexWrap: 'wrap' }}>
        <PasswordField label="Disabled (empty)" placeholder="Input Placeholder..." helperText="Input helper text" disabled />
        <PasswordField label="Disabled (with value)" defaultValue="secret123" helperText="Input helper text" disabled />
    </div>
);
...
export const WithIcon: StoryObj<WithIconControls> = {
  ...
  parameters: {
    docs: {
      description: {
        story:
          'PasswordField supports optional icons at the start and/or end of the input.',
      },
      source: {
        code: `
import { PasswordField, Icon } from '@mis-design/react';
