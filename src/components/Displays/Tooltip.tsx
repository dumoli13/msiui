...
const Tooltip = ({
  ...
  return (
    <div className="relative">
      {/* Wrap children to ensure hover/focus works on disabled buttons */}
      <span
        ref={elementRef}
        role="button"
      ...
      {open && (
        <Portal>
          <div
            ...
            role="tooltip"
            id={tooltipId}
            className="fixed z-[2100] bg-neutral-90 dark:bg-neutral-90-dark text-neutral-10 dark:text-neutral-10-dark rounded-sm px-2 py-1.5 mt-1 text-14px"
          >
            {arrow && (
              <div
                ...
                style={{
                  top: (() => {
                    if (verticalAlign === 'top') return '100%';
                    if (verticalAlign === 'bottom') return '-0.375rem';
                    return '50%';
                  })(),
                  left: (() => {
                    if (horizontalAlign === 'left') return '0.75rem';
