...
const RichTextFieldInner = ({ value, inputRef }: InnerProps) => {
      ...
      >
        <EditorProvider
          ...
          editorProps={{
            attributes: {
              class: cx(
                'richtextfield-content outline-none px-3 py-2 min-h-[120px]',
                {
        ...
        >
          <RichTextFieldInner value={value} inputRef={inputRef} />
        </EditorProvider>
      </InputBase>
