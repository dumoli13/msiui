        ...
        className={cx(
          'relative rounded-md font-medium disabled:cursor-not-allowed shrink-0',
          {
            ...
            'bg-neutral-10 hover:bg-neutral-20 active:bg-neutral-30 border focus:ring-3 border-neutral-40 disabled:text-neutral-60 disabled:bg-neutral-30 drop-shadow disabled:border-neutral-40':
              variant === 'outlined',
            'text-primary-main focus:ring-primary-focus':
              color === 'primary' && variant === 'outlined',
            'text-success-main focus:ring-success-focus':
              color === 'success' && variant === 'outlined',
            'text-danger-main focus:ring-danger-focus':
              color === 'danger' && variant === 'outlined',
            'text-warning-main focus:ring-warning-focus':
